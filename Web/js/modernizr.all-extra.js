...
Modernizr.addTest('raf', !!Modernizr.prefixed('requestAnimationFrame', window));// https://developer.mozilla.org/en-US/docs/API/Pointer_Lock_API
...
Modernizr.addTest('performance', !!Modernizr.prefixed('performance', window));// defer script
// By Theodoor van Donge
